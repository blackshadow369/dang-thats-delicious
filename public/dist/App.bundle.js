...
function autocomplete(input, latInput, lngInput) {
    ...
    //if someone presses enter on address field we dont wanna submit
...
function loadPlaces(map) {
    ...
    var lng = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : -79.84;
    ...
    _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
        ...
        //when someone clicks on marker show info abt that marker
...
function typeAhead(search) {
    ...
    searchInput.on('input', function () {
        ...
        _axios2.default.get('/api/search/?q=' + this.value).then(function (res) {
            ...
            //no results found
            searchResults.innerHTML = _dompurify2.default.sanitize('<div class="search__result">No search results for ' + _this.value + ' found!</div>');
        }).catch(function (err) {
            console.log(err);
        });
    });
